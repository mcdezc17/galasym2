...
begin
    ...
    for(i=1;i<=30;i+=1){
        ...
        if(i == 1){
            ...
            printf("#%31s sumF_%4.2frp", "ID_OBJ", scale_r[i], > residual_alpha_dir//"/"//"asymmpix_set.cat")
            ...
            printf(" sumF_%4.2frp", scale_r[i], >> residual_alpha_dir//"/"//"asymmpix_set.cat")
    ...
    # IV. (PROFILE CURVE)
    printf("#%31s %11s %11s %11s %11s prfl_1.0rp prfl_1.5rp prfl_2.0rp\n", "ID_OBJ", "X_IMG", "Y_IMG", "RAJ00", "DECJ00", > rotation_alpha_dir//"/"//"rot_prfl_index_main.cat")

    # V. (CUMMULATIVE CURVE)
    printf("#%31s %11s %11s %11s %11s cum%3.1f_1.0rp cum%3.1f_1.5rp cum%3.1f_2.0rp\n", "ID_OBJ", "X_IMG", "Y_IMG", "RAJ00", "DECJ00", > rotation_alpha_dir//"/"//"rot_cum_index_main.cat")
